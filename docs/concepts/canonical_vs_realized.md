...
Realized mode is also the right operational lens for action-bearing spans such as tool arguments, selectors, URLs, and SQL predicates because the emitted value is what will be executed.
