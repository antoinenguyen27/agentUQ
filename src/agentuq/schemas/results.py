...
from agentuq.schemas.records import CapabilityLevel, CapabilityReport
...
class UQResult(BaseModel):
    ...
    def pretty(
        ...
        from agentuq.rendering import render_result
    ...
    def rich_renderable(
        ...
        from agentuq.rendering import render_result_rich
    ...
    def rich_console_render(
        ...
        from agentuq.rendering import print_result_rich
