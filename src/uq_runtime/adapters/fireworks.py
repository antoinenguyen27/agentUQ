...
from uq_runtime.adapters.base import as_dict, infer_capability, normalize_top_logprobs
from uq_runtime.adapters.openai_chat import OpenAIChatAdapter, _normalize_chat_logprobs
